...
# Form implementation generated from reading ui file 'modBusGui_5.ui'
#
# Created: Mon Oct 24 13:39:15 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(280, 580)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.textBrowser = QtGui.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(10, 310, 260, 200))
        self.textBrowser.setObjectName(_fromUtf8("textBrowser"))
        self.gridLayoutWidget_2 = QtGui.QWidget(self.centralwidget)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 40, 261, 263))
        ...
        self.radioButton_ManReq = QtGui.QRadioButton(self.gridLayoutWidget_2)
        self.radioButton_ManReq.setObjectName(_fromUtf8("radioButton_ManReq"))
        self.grid_Params.addWidget(self.radioButton_ManReq, 7, 1, 1, 1)
        self.spinBox_ReqPeriod = QtGui.QSpinBox(self.gridLayoutWidget_2)
        self.spinBox_ReqPeriod.setObjectName(_fromUtf8("spinBox_ReqPeriod"))
        self.grid_Params.addWidget(self.spinBox_ReqPeriod, 9, 1, 1, 1)
        self.label_ReqPeriod = QtGui.QLabel(self.gridLayoutWidget_2)
        self.label_ReqPeriod.setObjectName(_fromUtf8("label_ReqPeriod"))
        self.grid_Params.addWidget(self.label_ReqPeriod, 9, 0, 1, 1)
        self.radioButton_AutoReq = QtGui.QRadioButton(self.gridLayoutWidget_2)
        self.radioButton_AutoReq.setObjectName(_fromUtf8("radioButton_AutoReq"))
        self.grid_Params.addWidget(self.radioButton_AutoReq, 7, 0, 1, 1)
        # self.button_dummy = QtGui.QPushButton(self.centralwidget)
        self.button_request = QtGui.QPushButton(self.centralwidget)
        self.button_request.setGeometry(QtCore.QRect(185, 520, 85, 27))
        self.button_request.setObjectName(_fromUtf8("button_request"))
        self.checkBox_Connected = QtGui.QCheckBox(self.centralwidget)
        self.checkBox_Connected.setGeometry(QtCore.QRect(10, 520, 88, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_regAddr.setText(_translate("MainWindow", " Register address", None))
        ...
        self.radioButton_ManReq.setText(_translate("MainWindow", "Man. requests", None))
        self.label_ReqPeriod.setText(_translate("MainWindow", " Request period [sec]", None))
        self.radioButton_AutoReq.setText(_translate("MainWindow", "Auto requests", None))
