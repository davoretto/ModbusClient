...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser.setGeometry(QtCore.QRect(10, 280, 260, 200))
        self.textBrowser.setObjectName(_fromUtf8("textBrowser"))
        self.gridLayoutWidget_2 = QtGui.QWidget(self.centralwidget)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 261, 274))
        ...
        self.spinBox_ReqPeriod.setMinimum(1)
        ...
        self.comboBox_ReqMethod = QtGui.QComboBox(self.gridLayoutWidget_2)
        self.comboBox_ReqMethod.setObjectName(_fromUtf8("comboBox_ReqMethod"))
        self.comboBox_ReqMethod.addItem(_fromUtf8(""))
        self.comboBox_ReqMethod.addItem(_fromUtf8(""))
        self.grid_Params.addWidget(self.comboBox_ReqMethod, 7, 1, 1, 1)
        self.label_numOfReg_2 = QtGui.QLabel(self.gridLayoutWidget_2)
        self.label_numOfReg_2.setObjectName(_fromUtf8("label_numOfReg_2"))
        self.grid_Params.addWidget(self.label_numOfReg_2, 7, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_ReqPeriod.setText(_translate("MainWindow", "Auto Request period [s]", None))
        ...
        self.comboBox_ReqMethod.setItemText(0, _translate("MainWindow", "Manual", None))
